            ...
            <Form role="form">
              ...
              <FormGroup className="mb-3">
                <InputGroup className="input-group-alternative">
                  ...
                  <Input placeholder="Org Type" type="text" onChange={e => { inputChangeHandler(e.target.value, 'orgType') }} autoComplete="" />
                </InputGroup>
              </FormGroup>
              <FormGroup>
                <InputGroup className="input-group-alternative">
              ...
              {isLoading ?
                ...
                : ""}
              <div className="text-center">
                <Button className="my-4" color="primary" type="button" disabled={!password || !email || !orgType} onClick={() => { login() }}>
                  Sign in
                </Button>
              </div>
            </Form>
